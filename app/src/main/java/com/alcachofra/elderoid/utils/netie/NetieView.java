...
public class NetieView extends AppCompatImageView {
    ...
    public NetieView(Context context) {
        super(context);
        scaleUp = AnimationUtils.loadAnimation(context, R.anim.small_scale_up);
        scaleDown = AnimationUtils.loadAnimation(context, R.anim.small_scale_down);
    }

    public NetieView(Context context, AttributeSet attrs) {
        super(context, attrs);
        scaleUp = AnimationUtils.loadAnimation(context, R.anim.small_scale_up);
        scaleDown = AnimationUtils.loadAnimation(context, R.anim.small_scale_down);
    }
