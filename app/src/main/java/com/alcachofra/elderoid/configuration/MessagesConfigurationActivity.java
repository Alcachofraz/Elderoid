...
public class MessagesConfigurationActivity extends ElderoidActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_messages_configuration);
        ...
        netie = new Netie(
                ...
                Arrays.asList(
                        new Cue(Elderoid.string(R.string.config_messages), R.drawable.netie_happy),
                        new Cue(
                ...
                false,
                v-> startActivity(new Intent(getApplicationContext(), ContactsConfigurationActivity.class))
        );
    ...
    void proceed(boolean accepted) {
        SimplePrefs.putBoolean(Elderoid.FUNC_MESSAGES, accepted);
        // Next Configuration Activity:
        startActivity(new Intent(getApplicationContext(), AppsConfigurationActivity.class));
    }
}